...
//组织sql指令
$sql = "SELECT edition_ID,edition_name,volume FROM edition WHERE edition.singer_ID = 
(SELECT singer_ID FROM singer WHERE singer_name = '$text') ORDER BY volume DESC
